...
namespace Notation.Plugin.AzureKeyVault.Client.Tests
{
    public class KeySpecExtensionTests
    {
        ...
        [InlineData(KeyType.EC, 384, "ES384")]
        [InlineData(KeyType.EC, 521, "ES512")]
        public void ToSignatureAlgorithmPKCS1_ValidKeySpecs_ReturnsCorrectSignatureAlgorithm(KeyType keyType, int keySize, string expectedAlgorithm)
        {
            // Arrange
            var keySpec = new KeySpec(keyType, keySize);
            // Act
        ...
        [InlineData(KeyType.RSA, 1024)]
        [InlineData(KeyType.EC, 128)]
        public void ToSignatureAlgorithmPKCS1_InvalidKeySpecs_ThrowsArgumentException(KeyType keyType, int keySize)
        {
            // Arrange
            var keySpec = new KeySpec(keyType, keySize);
        ...
        [Theory]
        [InlineData(KeyType.RSA, 2048, null, "PS256")]
        [InlineData(KeyType.RSA, 2048, "", "PS256")]
        [InlineData(KeyType.RSA, 2048, "rsassa-pss", "PS256")]
        [InlineData(KeyType.RSA, 2048, "RSASSA-PSS", "PS256")]  // Case insensitive
        [InlineData(KeyType.RSA, 2048, "rsassa-pkcs1-v1_5", "RS256")]
        [InlineData(KeyType.RSA, 2048, "RSASSA-PKCS1-V1_5", "RS256")]  // Case insensitive
        [InlineData(KeyType.RSA, 3072, "rsassa-pkcs1-v1_5", "RS384")]
        [InlineData(KeyType.RSA, 4096, "rsassa-pkcs1-v1_5", "RS512")]
        [InlineData(KeyType.EC, 256, "rsassa-pkcs1-v1_5", "ES256")]  // EC is unaffected by padding scheme
        [InlineData(KeyType.EC, 384, "rsassa-pkcs1-v1_5", "ES384")]
        [InlineData(KeyType.EC, 521, "rsassa-pkcs1-v1_5", "ES512")]
