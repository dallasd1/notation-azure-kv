...
namespace Notation.Plugin.Protocol.Tests
{
    public class KeySpecTests
    {
        ...
        [InlineData(KeyType.EC, 256, "ECDSA-SHA-256")]  // EC uses same algorithm
        ...
        [Theory]
        [InlineData(KeyType.RSA, 2048, null, "RSASSA-PSS-SHA-256")]
        [InlineData(KeyType.RSA, 2048, "", "RSASSA-PSS-SHA-256")]
        [InlineData(KeyType.RSA, 2048, "rsassa-pss", "RSASSA-PSS-SHA-256")]
        [InlineData(KeyType.RSA, 2048, "RSASSA-PSS", "RSASSA-PSS-SHA-256")]  // Case insensitive
        [InlineData(KeyType.RSA, 2048, "rsassa-pkcs1-v1_5", "RSASSA-PKCS1-v1_5-SHA-256")]
        [InlineData(KeyType.RSA, 2048, "RSASSA-PKCS1-V1_5", "RSASSA-PKCS1-v1_5-SHA-256")]  // Case insensitive
        [InlineData(KeyType.RSA, 3072, "rsassa-pkcs1-v1_5", "RSASSA-PKCS1-v1_5-SHA-384")]
        [InlineData(KeyType.RSA, 4096, "rsassa-pkcs1-v1_5", "RSASSA-PKCS1-v1_5-SHA-512")]
        [InlineData(KeyType.EC, 256, "rsassa-pkcs1-v1_5", "ECDSA-SHA-256")]  // EC is unaffected
        [InlineData(KeyType.EC, 384, "rsassa-pss", "ECDSA-SHA-384")]  // EC is unaffected
